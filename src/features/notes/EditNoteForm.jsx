...
const EditNoteForm = ({ note, users }) => {
  ...
  const onCompletedChanged = () => setCompleted(prevCompleted => !prevCompleted)
      ...
      <form className='form' onSubmit={(event) => event.preventDefault()}>
        ...
        <div className='form__row'>
          <div className='form-divider'>
            <label className='form__label form__checkbox-container' htmlFor='note-completed'>WORK COMPLETE:</label>
            <input 
          ...
          <div className='form-divider'>
            <p className='form__created'>{created}</p>
            <p className='form__updated'>{updated}</p>
          </div>
        </div>
      </form>
    </>
